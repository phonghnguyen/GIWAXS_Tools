...
The X-ray photon energy is 12.7 keV at SSRL 11-3, where these images where collected. The pixel size (in x and y) is 0.073242 mm. The sample-to-detector distance is 289.52 mm, which can be verified using Nika to fit the LaB6. The corresponding .txt files are generated by the instrument to record experimental conditions at the time of the experiment. 